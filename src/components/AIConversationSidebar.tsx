                ...
                <div className="ml-4 space-y-3 border-l border-white/10 pl-4">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full rounded-2xl border border-white/10 bg-white/8 py-2.5 pl-10 pr-3 text-sm text-slate-100 outline-none transition placeholder:text-slate-400 focus:border-sky-300/40 focus:ring-2 focus:ring-sky-300/15"
                    />
                  </div>
